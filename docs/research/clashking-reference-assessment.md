...
| Discord, Sheets, and OBS | The MIT bot is a clan-management/war-tracking Discord application ([README](https://github.com/ClashKingInc/ClashKingBot/blob/906e4c19f04a2192c97ee988093608854aec2f07/README.md#L28-L101)). Inspected target repositories showed no Google Sheets or OBS browser-overlay implementation. | **No current adoption.** | Minimal Discord workflow and Sheets/OBS designs remain open; retain one private Python service API contract rather than adapting bot-specific outputs. |
...
**Recommendation:** do not use these MIT applications to decide Discord workflow, website framework, account model, or product terminology. No inspected source provided a Google Sheets exporter or OBS browser overlay; build those later as thin consumers of the private Clash Lens Python service API and shared, versioned analytics summaries.
