...
- **Runbooks** — [`docs/collector-prototype.md`](docs/collector-prototype.md) and [`docs/deployment.md`](docs/deployment.md) for the current Go deployment; [`python/README.md`](python/README.md) and [`python/deployment.md`](python/deployment.md) for the throwaway Python seam.
